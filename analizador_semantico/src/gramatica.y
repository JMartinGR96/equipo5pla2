...
sentencia_if                : SI PARIZQ expresion PARDER THEN sentencia { comprobarBooleano($3);}
                            | SI PARIZQ expresion PARDER THEN sentencia ELSE sentencia { comprobarBooleano($3);}
                              ;
